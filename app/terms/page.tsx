      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              Tool owners set their own daily rental rates. Renters pay the daily rate multiplied by the number of rental days. ToolUnity retains 20% of the rental fee as a platform fee (covering payment processing, hosting, and admin); owners receive 80%.
            </p>
